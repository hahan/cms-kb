...
|---|---|---|---|---|---|---|
| Q1 | Can I return this TV without a receipt? | Must select the electronics policy/SOP, not marketplace or general merchandise | faq-returns-elec [FAQ: Electronics Returns] score=0.686 | PASS | ret-elec-v2 [ret-elec-v2-b2 [eligibility_criteria]] score=0.610 | PASS |
| Q2 | What's the return window for electronics? | Must return the CURRENT version (30 days), not the superseded one (14 days) | faq-returns-elec [FAQ: Electronics Returns] score=0.577 | FAIL | ret-elec-v2 [ret-elec-v2-b1 [intro]] score=0.583 | PASS |
...
**Score: baseline 6/9, enhanced 9/9**
